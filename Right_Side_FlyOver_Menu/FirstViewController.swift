...
class FirstViewController: UIViewController, DrawerMenuUtilityViewControllerDelegate {
    ...
    */
    ...
    @IBAction func buttonActionShow(_ sender: AnyObject) {
        ...
        viewControllerObject.stringFromViewController = "FirstViewController"
